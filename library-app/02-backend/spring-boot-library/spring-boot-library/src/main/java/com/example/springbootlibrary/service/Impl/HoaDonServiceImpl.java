...
import com.example.springbootlibrary.entity.ChiTietSanPham;
import com.example.springbootlibrary.entity.HoaDon;
import com.example.springbootlibrary.dao.ChiTietSanPhamRepository;
import com.example.springbootlibrary.dao.HoaDonRespository;
import com.example.springbootlibrary.responsemodels.HoaDonCustom;
import com.example.springbootlibrary.service.HoaDonService;
...
public class HoaDonServiceImpl implements HoaDonService {
    ...
    public HoaDon detailHD(UUID id) {
        return (HoaDon) res.findById(id).orElse(null);
    }
